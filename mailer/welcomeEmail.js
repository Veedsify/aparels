...
function welcomeEmail(name, verifyLink, email) {
  const template = `
  <!DOCTYPE html
...
<body class="main full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
                ...
                <div class="column"
                  ...
                  <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                    <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top"
                      style="border: 0;display: block;height: auto;width: 100%;max-width: 93px;" alt="" width="93"
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <h2
                        style='Margin-top: 16px;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #595959; text-align:center; font-size: 17px;line-height: 26px;font-family: Futura,"Century Gothic",Corbel,sans-serif;'>
                        <span class="font-futura" style="text-decoration: inherit;"><span
                            style="text-decoration: inherit;color: #ff0043;"><strong>Complete
                              Registeration:</strong></span></span></h2>
                    </div>
                  </div>

                  <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                    <img style="border: 0;display: block;height: auto;width: 100%;max-width: 450px;" alt="" width="450"
                      src="https://i.ibb.co/GnYbcB6/undraw-Confirmation-re-b6q5-1.png" />
                  </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <p class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-size: 16px;line-height: 24px;"
                        lang="x-size-16">Hi ${name},</p>
                      <p class="size-16" style="Margin-top: 20px;Margin-bottom: 0;font-size: 16px;line-height: 24px;"
                        lang="x-size-16">Thanks for signing up on Medic Apparels, to complete your registeration and</p>
                      <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;"
                        lang="x-size-16">verify you account please click the button below:</p>
                    </div>
                  </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                    <div class="btn btn--ghost btn--large" style="text-align:center;">
                      <!--[if !mso]><!--><a
                        style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ff0000 !important;border: 1px solid #6b7489;font-family: Lato, Tahoma, sans-serif;border-color: #ff7f7f;"
                        href="${verifyLink}">Confirm Email</a><!--<![endif]-->
                      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${verifyLink}" style="width:102.75pt" arcsize="8%" filled="f" strokecolor="#6B7489" strokeweight="1px"><v:textbox style="mso-fit-shape-to-text:t" inset="0pt,8.25pt,0pt,8.25pt"><center style="font-size:14px;line-height:24px;color:#FF0000;font-family:Lato,Tahoma,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:1.5px">Confirm Email</center></v:textbox></v:roundrect><![endif]-->
                    </div>
                  </div>
          ...
          <div role="contentinfo">
            ...
            <div class="layout email-flexible-footer email-footer"
              ...
              <div class="layout__inner right-aligned-footer"
                ...
                <!--[if mso]></td><![endif]-->
                <!--[if mso]><td valign="top" class="w60"><![endif]-->
                <div class="column"
                  style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;display: none;"
                  dir="ltr">
                ...
                <!--[if mso]></td><![endif]-->
                <!--[if mso]><td valign="top" class="w260"><![endif]-->
                    ...
                    <tr>
                      <td>
                        <div class="column js-footer-additional-info"
                          style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;width: 600px;"
                          dir="ltr">
                          <div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
                            <div class="email-footer__additional-info"
                              ...
                              <div bind-to="address">
                                <p class="email-flexible-footer__additionalinfo--center"
                                  style="Margin-top: 0;Margin-bottom: 0;">Medic Apparels</p>
                              </div>
                            </div>
                            <!--[if mso]>&nbsp;<![endif]-->
                          </div>
 ...
 `;
  ...
  mailer.sendMail(
    {
      subject: `Welcome to Medic Apparels, Please complete your registration`,
