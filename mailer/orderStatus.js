            ...
            <div class="header"
              ...
              <div class="logo emb-logo-margin-box"
                ...
                <div class="logo-center" align="center" id="emb-email-header"><img
                    style="display: block;height: auto;width: 100%;border: 0;max-width: 78px;" src="images/logo.png"
                    alt="" width="78" /></div>
              </div>
              <!--[if mso]></td></tr></table><![endif]-->
            </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <h3
                        ...
                        <span class="font-lato" style="text-decoration: inherit;">Your order status has changed.</span>
                      </h3>
                      ...
                      <p style="Margin-top: 20px;Margin-bottom: 0;font-family: Lato,Tahoma,sans-serif;"><span
                          class="font-lato" style="text-decoration: inherit;">${message}</span></p>
                    </div>
                  </div>
                    ...
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <h3 class="size-17"
                        ...
                        lang="x-size-17"><span class="font-lato" style="text-decoration: inherit;"><span
                            style="text-decoration: inherit;color: #ff3b48;"><strong>Order
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <p style="Margin-top: 0;Margin-bottom: 0;font-family: Lato,Tahoma,sans-serif;"><span
                          class="font-lato" style="text-decoration: inherit;">ORDER ID:&nbsp;&nbsp; ${order.ORDER_ID}</span></p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;font-family: Lato,Tahoma,sans-serif;"><span
                          class="font-lato" style="text-decoration: inherit;">ORDER NAME:&nbsp;&nbsp;${order.ORDER_NAME}</span></p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;font-family: Lato,Tahoma,sans-serif;"><span
                          class="font-lato" style="text-decoration: inherit;">ORDER DESCRIPTION:&nbsp; &nbsp;${order.ORDER_DESC}</span></p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;font-family: Lato,Tahoma,sans-serif;"><span
                      ...
                      <p style="Margin-top: 20px;Margin-bottom: 20px;font-family: Lato,Tahoma,sans-serif;"><span
                          class="font-lato" style="text-decoration: inherit;">ORDER STATUS:&nbsp;&nbsp;${order.ORDER_STATUS}</span></p>
                    </div>
                  </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    ...
                    <div style="font-size: 12px;line-height: 19px;margin-bottom: 15px;Margin-top: 20px;">
                      <div>
                        ...
                        <p class="email-flexible-footer__additionalinfo--center"
                          style="Margin-top: 20px;Margin-bottom: 0;">22b Ladiga, Apapa Lagos</p>
                      </div>
                    </div>
                    <div style="font-size: 12px;line-height: 19px;margin-bottom: 15px;Margin-top: 18px;">
                      <div>
                        <p class="email-flexible-footer__additionalinfo--center"
                          style="Margin-top: 0;Margin-bottom: 0;">You are receiving this email as a member of Medic
                          Apparels.</p>
                      </div>
                    </div>
                    <!--[if mso]>&nbsp;<![endif]-->
