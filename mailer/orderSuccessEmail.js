...
async function orderConfirmedEmail(name, phone, email, ORDER_ID, orderName, orderQuantity, orderPrice, fees, total, address, deliveryMethod, pickupAddress, estimatedDeliveryDate, orderDesc, order) {
  const template = `
      ...
      <tbody>
        <tr>
          <td>
              ...
              >
                ...
                >
                  ...
                  >
                      ...
                      >
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >You're getting this email because you made an order
                            on Medic Apparels</span
                          >
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <img
                        class="gnd-corner-image gnd-corner-image-center gnd-corner-image-bottom"
                        style="
                          border: 0;
                          display: block;
                          height: auto;
                        ...
                        alt=""
                        width="349"
                        src="${process.env.SITE_LINK}${order.ORDER_IMAGE}"
                      />
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
              ...
              >
                ...
                >
                  ...
                  >
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            style="text-decoration: inherit"
                            ><span
                              style="text-decoration: inherit; color: #ff3b48"
                      ...
                      >
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >ORDER DESCRIPTION: &nbsp;&nbsp; ${orderDesc}</span
                          >
                        </p>
                        <p
                          style="
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >ORDER PRICE: &nbsp;&nbsp; ${Number(orderPrice).toLocaleString()}</span
                          >
                        </p>
                        <p
                          style="
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >ORDER QUANTITY: &nbsp;&nbsp; ${orderQuantity}</span
                          >
                        </p>
                        <p
                          style="
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >SUBTOTAL: &nbsp;&nbsp; ${Number(total).toLocaleString()}</span
                          >
                        </p>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            ><span
                              style="text-decoration: inherit; color: #ff3b48"
                              ><strong>Delivery Details</strong></span
                            ></span
                          >
                        </h3>
                      </div>
                      ...
                      >
                        ...
                        >
                          <span
                            class="font-lato"
                            style="text-decoration: inherit"
                            >DELIVERY METHOD: &nbsp;&nbsp; ${deliveryMethod}</span 
                          >
                        </p>
                      </div>
                    </div>
                    ...
                    <div style="margin-left: 20px; margin-right: 20px">
                      <div
                        class="btn btn--ghost btn--medium"
                      ...
                      >
                        <!--[if !mso
                          ...
                          style="
                            ...
                            border: 1px solid #41637e;
                            font-family: Lato, Tahoma, sans-serif;
                            border-color: #ff3b48;
                          "
                          href="${process.env.SITE_LINK}/order/track/${ORDER_ID}"
                          >Track Order</a
                        ><!--<![endif]-->
                        <!--[if mso
            ...
            <div role="contentinfo">
              ...
              >
                <div
                  ...
                  style="border-collapse: collapse; display: table; width: 100%"
                >
                  <!--[if mso]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
                  <div
                    class="column wide"
                    style="
                      text-align: left;
                      ...
                      >
                        <div>
                          <p
                            ...
                            style="margin-top: 0; margin-bottom: 0"
                          >
                            You are receiving this email as a member of Medic
                            Apparels.
                          </p>
                        </div>
                      </div>
            ...
            <div style="line-height: 40px; font-size: 40px" id="footer-spacing">
              &nbsp;
            </div>
          </td>
        </tr>
...
module.exports = orderConfirmedEmail;
