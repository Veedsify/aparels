/*-----------------------------------------------------------------------------------
 ...
 Template Name:Medic Apparels
 Template URI: themes.pixelstrap.com/Medic Apparels
...
$('.cookie-bar .btn, .cookie-bar .btn-close').on('click', function () {
    ...
    setCookie('client_auth', randomString, 7);
});
...
//     cartEffect.text("Already Added ");
//     const image = $(e.target).data('productimg');
...
$(function () {
    ...
    $('.quantity-left-minus, .quantity-right-plus').click(function () {
        const increment = $(this).hasClass('quantity-right-plus') ? 1 : -1;
        const maxQuantity = 20
        let currentValue = parseInt(quantityValue.val());
        if (currentValue + increment >= 0 && currentValue + increment <= maxQuantity) {
            quantityValue.val(currentValue + increment);
        }
    });
});
