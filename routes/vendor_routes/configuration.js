...
router.get("/pages/home", (req, res) => {
    res.render("vendor/configure-home");
});
...
router.get("/payment", (req, res) => {
    ...
    res.render("vendor/configure-payments", { payment: payment });
});
...
router.get("/email", async (req, res) => {
    ...
    res.render("vendor/configure-email", { smtp: smtp, emails: emails });
});
...
router.get("/pages/about", async (req, res) => {
    ...
    res.render("vendor/config-about", { teams: data, content: content[0] });
});
router.get("/pages/privacy", (req, res) => {
    res.render("vendor/config-privacy");
});
router.get("/pages/terms", (req, res) => {
    res.render("vendor/config-terms");
});
router.get("/pages/shiping-returns", (req, res) => {
    res.render("vendor/config-shipping-returns");
});
